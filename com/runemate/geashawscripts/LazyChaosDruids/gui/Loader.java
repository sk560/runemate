...
public class Loader extends Stage {
    ...
    public void start(Stage stage) throws Exception {
        InputStream fxmlInput = LazyChaosDruids.class.getResourceAsStream("/com/runemate/geashawscripts/LazyChaosDruids/gui/LazyChaosDruids.fxml");
        if (fxmlInput != null) {
            ...
            stage.setTitle("LazyChaosDruids");
