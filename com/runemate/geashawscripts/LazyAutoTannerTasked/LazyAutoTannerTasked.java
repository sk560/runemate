...
import com.runemate.geashawscripts.LazyAutoTannerTasked.Tasks.Bank;
import com.runemate.geashawscripts.LazyAutoTannerTasked.Tasks.Cast;
import com.runemate.geashawscripts.LazyAutoTannerTasked.Tasks.Exit;
import com.runemate.geashawscripts.LazyAutoTannerTasked.Tasks.Update;
 ...
 */
public class LazyAutoTannerTasked extends TaskScript implements PaintListener, InventoryListener, MouseListener, MouseMotionListener {
    ...
    public void onPaint(Graphics2D g) {
        ...
        g.drawString("Hides tanned: " + Methods.formatNumber(Constants.hidesTanned) + " (" + Methods.formatNumber(Methods.getHourly(Constants.hidesTanned, Constants.runtime.getRuntime())) + ")", TextXLocation, TextYLocation += 15);
