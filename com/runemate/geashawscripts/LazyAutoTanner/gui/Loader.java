...
public class Loader extends Stage {
    ...
    public void start(Stage stage) throws Exception {
        InputStream fxmlInput = LazyAutoTanner.class.getResourceAsStream("/com/runemate/geashawscripts/LazyAutoTanner/gui/LazyAutoTannerGui.fxml");
        if (fxmlInput != null) {
